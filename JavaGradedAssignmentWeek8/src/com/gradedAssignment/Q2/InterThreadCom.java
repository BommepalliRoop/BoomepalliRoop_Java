package com.gradedAssignment.Q2;
...
import com.gradedAssignment.Q1.Employee;
import com.gradedAssignment.Q1.Project;
class Thread1 {
    ...
    public synchronized void serializeMap() {
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("D://map.txt"))) {
